...
The goal is to create a modular development toolbox to makes building Apps smoother for developers. Therefore, the benefits will trickle right to the site owners and end users.

## Features

- Isolate Apps to make dropping in the App and working with VSCode, git, and beyond more approachable and sustainable.
- Standardized UI with Nuxt UI for everyone and the option of Nuxt UI Pro for commercial projects.
- Set up NuxtHub-style projects for the wonderful feature of automated database migrations.
